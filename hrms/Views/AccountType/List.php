...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Account Types | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Account Types</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Account Types[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_account_types";
                                    $stmt = $conn->query($sql_select);
                                    $account_types = $stmt->fetchAll();
                                    echo count($account_types);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayaccounttypes" style="height: auto; width: 100%;">

                                <div id="listAccountTypesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listAccountTypesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($account_types) > 0) {
                                            ...
                                            foreach ($account_types as $account_type) {
                                                echo "<tr>";
                                                echo "<td>" . $account_type['auto_id'] . "</td>";
                                                echo "<td>" . $account_type['at_description'] . "</td>";
                                                echo "<td>" . $account_type['at_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $account_type['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $account_type['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteAccountType.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/AccountType/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
