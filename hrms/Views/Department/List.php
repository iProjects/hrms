...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Departments | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Departments</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Departments[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_departments";
                                    $stmt = $conn->query($sql_select);
                                    $departments = $stmt->fetchAll();
                                    echo count($departments);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaydepartments" style="height: auto; width: 100%;">

                                <div id="listDepartmentsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listDepartmentsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($departments) > 0) {
                                            ...
                                            foreach ($departments as $department) {
                                                echo "<tr>";
                                                echo "<td>" . $department['auto_id'] . "</td>";
                                                echo "<td>" . $department['dep_description'] . "</td>";
                                                echo "<td>" . $department['dep_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $department['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $department['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteDepartment.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                try {
                    ...
                    $('#listDepartmentsTable').DataTable(
                            {
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Department/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
