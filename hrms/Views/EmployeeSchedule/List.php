...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Employee Schedules | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Employee Schedules</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Employee Schedules[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_employee_schedules";
                                    $stmt = $conn->query($sql_select);
                                    $employee_schedules = $stmt->fetchAll();
                                    echo count($employee_schedules);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayemployeeschedules" style="height: auto; width: 100%;">

                                <div id="listEmployeeSchedulesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listEmployeeSchedulesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Employee</th>";
                                        ...
                                        if (count($employee_schedules) > 0) {
                                            ...
                                            foreach ($employee_schedules as $employee_schedule) {
                                                echo "<tr>";
                                                echo "<td>" . $employee_schedule['auto_id'] . "</td>";
                                                echo "<td>" . $employee_schedule['shd_employee_id'] . "</td>";
                                                echo "<td>" . $employee_schedule['shd_station_id'] . "</td>";
                                                echo "<td>" . $employee_schedule['shd_shift_id'] . "</td>";
                                                echo "<td>" . $employee_schedule['shd_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $employee_schedule['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $employee_schedule['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteEmployeeSchedule.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                try {
                    ...
                    $('#listEmployeeSchedulesTable').DataTable(
                            {
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/EmployeeSchedule/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
