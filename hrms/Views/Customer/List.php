...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Customers | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Customers</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Customers[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_customers";
                                    $stmt = $conn->query($sql_select);
                                    $customers = $stmt->fetchAll();
                                    echo count($customers);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaycustomers" style="height: auto; width: 100%;">

                                <div id="listCustomersResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listCustomersTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($customers) > 0) {
                                            ...
                                            foreach ($customers as $customer) {
                                                echo "<tr>";
                                                echo "<td>" . $customer['auto_id'] . "</td>";
                                                echo "<td>" . $customer['customer_firstname'] . "</td>";
                                                echo "<td>" . $customer['customer_lastname'] . "</td>";
                                                echo "<td>" . $customer['customer_surname'] . "</td>";
                                                echo "<td>" . $customer['customer_email'] . "</td>";
                                                echo "<td>" . $customer['customer_phone'] . "</td>";
                                                echo "<td>" . $customer['customer_date_of_birth'] . "</td>";
                                                echo "<td>" . $customer['customer_registration_date'] . "</td>";
                                                echo "<td>" . $customer['customer_country'] . "</td>";
                                                echo "<td>" . $customer['customer_address'] . "</td>";
                                                echo "<td>" . $customer['customer_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $customer['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $customer['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteCustomer.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Customer/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
