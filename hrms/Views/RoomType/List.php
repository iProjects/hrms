...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Room Types | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Room Types</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Room Types[ 
                                    <?php
                                    ...
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayroomtypes" style="height: auto; width: 100%;">

                                <div id="listRoomTypesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listRoomTypesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($room_types) > 0) {
                                            ...
                                            foreach ($room_types as $room_type) {
                                                echo "<tr>";
                                                echo "<td>" . $room_type['auto_id'] . "</td>";
                                                echo "<td>" . $room_type['room_type_description'] . "</td>";
                                                echo "<td>" . $room_type['room_type_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $room_type['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $room_type['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteRoomType.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/RoomType/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
