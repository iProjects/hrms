...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Create Room Type | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Create Room Type</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateRoomType.php" method="POST"  enctype="multipart/form-data">

                                <h1>Room Type Details Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Room Type Details Info</legend>
                                    ...
                                    <div class="divcol1container divcontainer">
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divinput">
                                                <input id="txtroom_type_description" name="txtroom_type_description" type="text" autocomplete="autocomplete" placeholder="Description" title="Description"   />
                                            </div>
...
//                                                    
        ...
        <script language="javascript" type="text/javascript">
            ...
            function sendAjax() {
                ...
                var description = $('#txtroom_type_description').val();
