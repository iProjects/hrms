...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Lost and Found | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Lost and Found</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Lost and Found [ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_lost_and_found";
                                    $stmt = $conn->query($sql_select);
                                    $lost_and_founds = $stmt->fetchAll();
                                    echo count($lost_and_founds);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaylostandfound" style="height: auto; width: 100%;">

                                <div id="listLostandFoundsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listLostandFoundsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Description</th>";
                                        echo "<th>Color</th>";
                                        echo "<th>Where Found</th>";
                                        echo "<th>Who Found</th>";
                                        echo "<th>Estimate Value</th>";
                                        ...
                                        if (count($lost_and_founds) > 0) {

                                            foreach ($lost_and_founds as $lost_and_found) {
                                                echo "<tr>";
                                                echo "<td>" . $lost_and_found['auto_id'] . "</td>";
                                                echo "<td>" . $lost_and_found['laf_item_description'] . "</td>";
                                                echo "<td>" . $lost_and_found['laf_color'] . "</td>";
                                                echo "<td>" . $lost_and_found['laf_where_found'] . "</td>";
                                                echo "<td>" . $lost_and_found['laf_who_found'] . "</td>";
                                                echo "<td>" . $lost_and_found['laf_estimate_value'] . "</td>";
                                                echo "<td>" . $lost_and_found['laf_current_location'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $lost_and_found['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $lost_and_found['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteLostandFound.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                try {
                    ...
                    $('#listLostandFoundsTable').DataTable(
                            {
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/LostandFound/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
