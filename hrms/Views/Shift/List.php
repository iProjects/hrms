...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Shifts | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Shifts</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Shifts[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_shifts";
                                    $stmt = $conn->query($sql_select);
                                    $shifts = $stmt->fetchAll();
                                    echo count($shifts);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayshifts" style="height: auto; width: 100%;">

                                <div id="listShiftsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        if (count($shifts) > 0) {
                                            ...
                                            foreach ($shifts as $shift) {
                                                echo "<tr>";
                                                echo "<td>" . $shift['auto_id'] . "</td>";
                                                echo "<td>" . $shift['shift_day_of_week'] . "</td>";
                                                echo "<td>" . $shift['shift_start_time'] . "</td>";
                                                echo "<td>" . $shift['shift_end_time'] . "</td>";
                                                echo "<td>" . $shift['shift_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $shift['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $shift['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteShift.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Shift/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
