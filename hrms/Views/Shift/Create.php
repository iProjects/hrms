...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Create Shift | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Create Shift</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateShift.php" method="POST"  enctype="multipart/form-data">

                                <h1>Shift Date Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Shift Date Info</legend>

                                    <div class="divcol1container divcontainer">

                                        <div class="divcol1">

                                            <div class="divlabel"><span>Shift Date : </span></div>

                                            <div class="divinput">
                                                <input id="dtpshift_day_of_week" name="dtpshift_day_of_week" type="date" autocomplete="autocomplete" placeholder="Shift Date" title="Shift Date"   />
                                            </div>
                                ...
                                <h1>Time Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Time Info</legend>

                                    <div class="divcol1container divcontainer">

                                        <div class="divcol1">

                                            <div class="divlabel"><span>Start Time : </span></div>

                                            <div class="divinput">
                                                <input id="txtshift_start_time"  name="txtshift_start_time" type="datetime" autocomplete="autocomplete" placeholder="Start Time" title="Start Time" />
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>End Time : </span></div>

                                            <div class="divinput">
                                                <input id="txtshift_end_time"  name="txtshift_end_time" type="datetime" autocomplete="autocomplete" placeholder="End Time" title="End Time"/>
                                            </div>
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function() {
                try {
                    ...
                    $('#dtpshift_day_of_week').val(formatDateForControl(new Date()));
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Station/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
            ...
            function sendAjax() {
                ...
                var shift_day_of_week = $('#dtpshift_day_of_week').val();
                var shift_start_time = $('#txtshift_start_time').val();
                var shift_end_time = $('#txtshift_end_time').val();
                var status = $('#cbostatus').val();

                if (shift_day_of_week.length == 0) {
                    errormsg += '<li>' + " Shift Date cannot be null " + '</li>';
                    $('#dtpshift_day_of_week').focus();
                    error_free = false;
                }
                if (shift_start_time.length == 0) {
                    errormsg += '<li>' + " Start Time cannot be null " + '</li>';
                    $('#txtshift_start_time').focus();
                    error_free = false;
                }
                if (shift_end_time.length == 0) {
                    errormsg += '<li>' + " End Time cannot be null " + '</li>';
                    $('#txtshift_end_time').focus();
                    error_free = false;
                }
                if (status.length == 0) {
