...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header"  >
        ...
        <title>Error | Hotel Reservation Managment System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divlogo">
                            ...
                            <img id="logo" alt="Hotel Reservation Managment System" src="../../Images/logo.jpg" runat="server" style="clear: both; float: left;" title="Hotel Reservation Managment System" />

                        </div>

                        <div id="divtitle">

                            <span class="pagetitle">Hotel Reservation Managment System - Error</span>
