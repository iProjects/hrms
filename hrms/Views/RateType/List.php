...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Rate Types | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Rate Types</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Rate Types[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_rate_types";
                                    $stmt = $conn->query($sql_select);
                                    $rate_types = $stmt->fetchAll();
                                    echo count($rate_types);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayratetypes" style="height: auto; width: 100%;">

                                <div id="listRateTypesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listRateTypesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($rate_types) > 0) {
                                            ...
                                            foreach ($rate_types as $rate_type) {
                                                echo "<tr>";
                                                echo "<td>" . $rate_type['auto_id'] . "</td>";
                                                echo "<td>" . $rate_type['rt_description'] . "</td>";
                                                echo "<td>" . $rate_type['rt_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $rate_type['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $rate_type['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteRateType.php" method="POST" id="form-delete-dialog">
