...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Payment Methods | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Payment Methods</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Payment Methods[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_payment_methods";
                                    $stmt = $conn->query($sql_select);
                                    $payment_methods = $stmt->fetchAll();
                                    echo count($payment_methods);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaypayment_methods" style="height: auto; width: 100%;">

                                <div id="listPaymentMethodsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listPaymentMethodsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Email</th>";
                                        ...
                                        if (count($payment_methods) > 0) {
                                            ...
                                            foreach ($payment_methods as $payment_method) {
                                                ...
                                                echo "<td>" . $payment_method['us_role'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $payment_method['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $payment_method['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeletePaymentMethod.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                try {
                    ...
                    $('#listPaymentMethodsTable').DataTable(
                            {
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/PaymentMethod/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
