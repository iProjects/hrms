...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Payments | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Payments</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Payments[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_payments";
                                    $stmt = $conn->query($sql_select);
                                    $payments = $stmt->fetchAll();
                                    echo count($payments);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaypayments" style="height: auto; width: 100%;">

                                <div id="listPaymentsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listPaymentsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Email</th>";
                                        ...
                                        if (count($payments) > 0) {
                                            ...
                                            foreach ($payments as $payment) {
                                                echo "<tr>";
                                                echo "<td>" . $payment['auto_id'] . "</td>";
                                                echo "<td>" . $payment['us_email'] . "</td>";
                                                echo "<td>" . $payment['us_pwd'] . "</td>";
                                                echo "<td>" . $payment['us_telephone'] . "</td>";
                                                echo "<td>" . $payment['us_status'] . "</td>";
                                                echo "<td>" . $payment['us_role'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $payment['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $payment['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeletePayment.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Payment/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
