...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Assets | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Assets</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Assets[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_assets";
                            ...
                            <div id="divtabledisplayassets" style="height: auto; width: 100%;">
                                ...
                                <div id="listAssetsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        if (count($assets) > 0) {
                                            ...
                                            foreach ($assets as $asset) {
                                                echo "<tr>";
                                                echo "<td>" . $asset['auto_id'] . "</td>";
                                                echo "<td>" . $asset['ast_description'] . "</td>";
                                                echo "<td>" . $asset['ast_asset_type'] . "</td>";
                                                echo "<td>" . $asset['ast_date_acquired'] . "</td>";
                                                echo "<td>" . $asset['ast_acquired_value'] . "</td>";
                                                echo "<td>" . $asset['ast_current_value'] . "</td>";
                                                echo "<td>" . $asset['ast_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $asset['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $asset['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Asset/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
