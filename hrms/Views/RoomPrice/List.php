...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Room Prices | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Room Prices</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Room Prices[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_room_prices";
                                    $stmt = $conn->query($sql_select);
                                    $room_prices = $stmt->fetchAll();
                                    echo count($room_prices);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayroomprices" style="height: auto; width: 100%;">

                                <div id="listRoomPricesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listRoomPricesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Current Room Price</th>";
                                        echo "<th>Additional Room Price</th>";
                                        ...
                                        if (count($room_prices) > 0) {
                                            ...
                                            foreach ($room_prices as $room_price) {
                                                echo "<tr>";
                                                echo "<td>" . $room_price['auto_id'] . "</td>";
                                                echo "<td>" . $room_price['rp_current_room_price'] . "</td>"; 
                                                echo "<td>" . $room_price['rp_additional_room_price'] . "</td>"; 
                                                echo "<td>" . $room_price['rp_parent_id'] . "</td>"; 
                                                echo "<td>" . $room_price['rp_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $room_price['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $room_price['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteRoomPrice.php" method="POST" id="form-delete-dialog">
