...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Create Room Price | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Create Room Price</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateRoomPrice.php" method="POST"  enctype="multipart/form-data">

                                <h1>Current Price Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Current Price Info</legend>

                                    <div class="divcol1container divcontainer">

                                        <div class="divcol1">

                                            <div class="divlabel"><span>Current Price : </span></div>

                                            <div class="divinput">
                                                <input id="txtrp_current_room_price" name="txtrp_current_room_price" type="number" autocomplete="autocomplete" placeholder="Current Price" title="Current Price" min="0"  />
                                            </div>
                                ...
                                <h1>Additional Room Price Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Additional Room Price Info</legend>

                                    <div class="divcol1container divcontainer">

                                        <div class="divcol1">

                                            <div class="divlabel"><span>Additional Room Price : </span></div>

                                            <div class="divinput">
                                                <input id="txtrp_additional_room_price"  name="txtrp_additional_room_price" type="number" autocomplete="autocomplete" placeholder="Additional Room Price" title="Additional Room Price" min="0" />
                                            </div>
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function() {
                try {
                    ...
                    $('#txtrp_current_room_price').val('0');
                    $('#txtrp_additional_room_price').val('0');
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/RoomPrice/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
            ...
            function sendAjax() {
                ...
                var rp_current_room_price = $('#txtrp_current_room_price').val();
                var rp_additional_room_price = $('#txtrp_additional_room_price').val();
                var status = $('#cbostatus').val();

                if (rp_current_room_price.length == 0) {
                    errormsg += '<li>' + " Current Price cannot be null " + '</li>';
                    $('#txtroom_type_description').focus();
                    error_free = false;
                }
                if (rp_additional_room_price.length == 0) {
                    errormsg += '<li>' + " Additional Room Price cannot be null " + '</li>';
                    $('#txtroom_type_description').focus();
                    error_free = false;
                }
                if (status.length == 0) {
            ...
            function suppressNonNumericInput() {
                $("#txtrp_current_room_price").keydown(function(e) {
                    ...
                    if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                            // Allow: Ctrl+A
                                ...
                                $("#txtrp_additional_room_price").keydown(function(e) {
                                    // Allow: backspace, delete, tab, escape, enter and .
                                    if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                                            // Allow: Ctrl+A
                                                    (e.keyCode == 65 && e.ctrlKey === true) ||
