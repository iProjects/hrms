...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Create Room | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Create Room</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateRoom.php" method="POST"  enctype="multipart/form-data">

                                <h1>Room Main Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Room Main Info</legend>
                                    ...
                                    <div class="divcol1container divcontainer">
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divinput">
                                                <input id="txtroom_description" name="txtroom_description" type="text" autocomplete="autocomplete" placeholder="Description" title="Description"/>
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Room Type : </span></div>
                                            ...
                                            <div class="divinput">
                                                ...
                                                try {
                                                    ...
                                                    //select all from db 
                                                    $sql_select = "SELECT * FROM hrms_room_types";
                                                    ...
                                                    echo '<select name="cboroom_type" id="cboroom_type" title="Room Type" style="width: 20px;">';
                                                    echo '<option selected value="">Select Room Type</option>';
                                                    if (count($room_types) > 0) {
                                                        //loop through each  object and display the description in a select.
                                                        foreach ($room_types as $room_type) {
                                                            echo "<option value=" . $room_type['auto_id'] . ">" . $room_type['room_type_description'] . "</option>";
                                                        }
                                                    }
                                                    echo "</select>";
...
//                                                    
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Hotel : </span></div>
                                            ...
                                            <div class="divinput">
                                                ...
                                                try {
                                                    ...
                                                    //select all from db 
                                                    $sql_select = "SELECT * FROM hrms_hotels";
                                                    //stmt and conn variables are defined in MySqlConnection.php. Call the connection object and 
                                                    //pass the select query and assign the result into stmt.
                                                    $stmt = $conn->query($sql_select);
                                                    //call pdo fetchall to convert the data into an enumerable object and assign the object
                                                    ...
                                                    echo '<select name="cboroom_hotel_id" id="cboroom_hotel_id" title="Hotel" style="width: 20px;">';
                                                    echo '<option selected value="">Select Hotel</option>';
                                                    if (count($hotels) > 0) {
                                                        //loop through each  object and display the description in a select.
                                                        foreach ($hotels as $hotel) {
                                                            echo "<option value=" . $hotel['auto_id'] . ">" . $hotel['hotel_name'] . "</option>";
                                                        }
                                                    }
                                                    echo "</select>";
                                                    //safely close the cursor.
...
//                                                    
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Price : </span></div>
                                            ...
                                            <div class="divinput">
                                                ...
                                                try {
                                                    ...
                                                    //select all from db 
                                                    $sql_select = "SELECT * FROM hrms_room_prices";
                                                    //stmt and conn variables are defined in MySqlConnection.php. Call the connection object and 
                                                    //pass the select query and assign the result into stmt.
                                                    $stmt = $conn->query($sql_select);
                                                    //call pdo fetchall to convert the data into an enumerable object and assign the object
                                                    ...
                                                    echo '<select name="cborm_room_price" id="cborm_room_price" title="Price" style="width: 20px;">';
                                                    echo '<option selected value="">Select Price</option>';
                                                    if (count($room_prices) > 0) {
                                                        //loop through each  object and display the description in a select.
                                                        foreach ($room_prices as $room_price) {
                                                            echo "<option value=" . $room_price['auto_id'] . ">" . ($room_price['rp_current_room_price'] + $room_price['rp_additional_room_price']) . "</option>";
                                                        }
                                                    }
                                                    echo "</select>";
                                                    //safely close the cursor.
...
//                                                    
                                ...
                                <h1>Additional Room Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Additional Room Info</legend>

                                    <div class="divcol1container divcontainer">

                                        <div class="divcol1">

                                            <div class="divlabel"><span>Room No : </span></div>

                                            <div class="divinput">
                                                <input id="txtroom_no"  name="txtroom_no" type="text" autocomplete="autocomplete" placeholder="Room No" title="Room No" />
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Photo : </span></div>

                                            <div class="divinput">
                                                <input id="txtroom_photo"  name="txtroom_photo" type="file" autocomplete="autocomplete" placeholder="Photo" title="Photo" />
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Max Room Capacity : </span></div>

                                            <div class="divinput">
                                                <input id="txtroom_max_capacity"  name="txtroom_max_capacity" type="number" autocomplete="autocomplete" placeholder="Max Room Capacity" title="Max Room Capacity" min="0" />
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Room Smoking : </span></div>

                                            <div class="divinput">
                                                <input id="chkroom_smoking"  name="chkroom_smoking" type="checkbox" autocomplete="autocomplete" placeholder="Room Smoking" title="Room Smoking" />
                                            </div>
                                ...
                                <h1>Status Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Status Info</legend>
...
//                                                    
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Room/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
            ...
            function sendAjax() {
                ...
                var room_description = $('#txtroom_description').val();
                var room_type = $('#cboroom_type').val();
                var room_hotel_id = $('#cboroom_hotel_id').val();
                var rm_room_price = $('#cborm_room_price').val();
                var room_no = $('#txtroom_no').val();
                var room_no_of_beds = $('#txtroom_no_of_beds').val();
                var room_photo = $('#txtroom_photo').val();
                var room_max_capacity = $('#txtroom_max_capacity').val();
                var room_smoking = $('#chkroom_smoking').val();
                var status = $('#cbostatus').val();

                if (room_description.length == 0) {
                    errormsg += '<li>' + " Description cannot be null " + '</li>';
                    $('#txtroom_description').focus();
                    error_free = false;
                }
                if (room_type.length == 0) {
                    errormsg += '<li>' + " Select Room Type " + '</li>';
                    $('#cboroom_type').focus();
                    error_free = false;
                }
                if (room_hotel_id.length == 0) {
                    errormsg += '<li>' + " Select Hotel " + '</li>';
                    $('#cboroom_hotel_id').focus();
                    error_free = false;
                }
                if (rm_room_price.length == 0) {
                    errormsg += '<li>' + " Select Price " + '</li>';
                    $('#cborm_room_price').focus();
                    error_free = false;
                }
                if (room_no.length == 0) {
                    errormsg += '<li>' + " Room No cannot be null " + '</li>';
                    $('#txtroom_no').focus();
                    error_free = false;
                }
                if (room_no_of_beds.length == 0) {
                    errormsg += '<li>' + " No Of Beds cannot be null " + '</li>';
                    $('#txtroom_no_of_beds').focus();
                    error_free = false;
                }
                if (room_photo.length == 0) {
                    errormsg += '<li>' + " Photo cannot be null " + '</li>';
                    $('#txtroom_photo').focus();
                    error_free = false;
                }
                if (room_max_capacity.length == 0) {
                    errormsg += '<li>' + " Max Capacity cannot be null " + '</li>';
                    $('#txtroom_max_capacity').focus();
                    error_free = false;
                }
                if (room_smoking.length == 0) {
                    errormsg += '<li>' + " Room Smoking cannot be null " + '</li>';
                    $('#chkroom_smoking').focus();
                    error_free = false;
                }
                if (status.length == 0) {
