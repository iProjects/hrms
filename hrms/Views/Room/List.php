...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Rooms | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Rooms</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Rooms[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_rooms";
                                    $stmt = $conn->query($sql_select);
                                    $rooms = $stmt->fetchAll();
                                    echo count($rooms);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayrooms" style="height: auto; width: 100%;">

                                <div id="listRoomsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        if (count($rooms) > 0) {
                                            ...
                                            foreach ($rooms as $room) {
                                                echo "<tr>";
                                                echo "<td>" . $room['auto_id'] . "</td>";
                                                echo "<td>" . $room['room_description'] . "</td>";
                                                echo "<td>" . $room['room_type'] . "</td>";
                                                echo "<td>" . $room['room_hotel_id'] . "</td>";
                                                echo "<td>" . $room['room_no'] . "</td>";
                                                echo "<td>" . $room['room_photo'] . "</td>";
                                                echo "<td>" . $room['rm_room_price'] . "</td>";
                                                echo "<td>" . $room['room_max_capacity'] . "</td>";
                                                echo "<td>" . $room['room_no_of_beds'] . "</td>";
                                                echo "<td>" . $room['room_smoking'] . "</td>";
                                                echo "<td>" . $room['room_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $room['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $room['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteRoom.php" method="POST" id="form-delete-dialog">
