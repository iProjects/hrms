...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Create Hotel | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Create Hotel</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateHotel.php" method="POST"  enctype="multipart/form-data">

                                <h1>Hotel Main Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Hotel Main Info</legend>

                                    <div class="divcol1container divcontainer">

                                        <div class="divcol1">

                                            <div class="divlabel"><span>Name : </span></div>

                                            <div class="divinput">
                                                <input id="txthotel_name" name="txthotel_name" type="text" autocomplete="autocomplete" placeholder="Name" title="Name"/>
                                            </div>
                                ...
                                <h1>Contact Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Contact Info</legend>

                                    <div class="divcol1container divcontainer">

                                        <div class="divcol1"  style="padding-bottom: 5px !important;">

                                            <div class="divlabel"><span>Phone No : </span></div>

                                            <div class="divinput">
                                                <input id="txthotel_phone"  name="txthotel_phone" type="tel" autocomplete="autocomplete" placeholder="Phone No" title="Phone No" style="padding: 5px !important; padding-left: 50px !important; min-height: 20px !important; width: 99% !important;"/>
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Email : </span></div>

                                            <div class="divinput">
                                                <input id="txthotel_email"  name="txthotel_email" type="text" autocomplete="autocomplete" placeholder="Email" title="Email" />
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Address : </span></div>

                                            <div class="divinput">
                                                <input id="txthotel_address"  name="txthotel_address" type="text" autocomplete="autocomplete" placeholder="Address" title="Address" />
                                            </div>
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divlabel"><span>Country : </span></div>

                                            <div class="divinput">
                                                <input id="cbohotel_country"  name="cbohotel_country" type="text" autocomplete="autocomplete" placeholder="Country" title="Country"  style="padding-left: 50px !important; width: 360px !important; height: 30px !important; min-height: 30px !important;"/>
                                            </div>
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function() {
                try {
                    ...
                    $("#cbohotel_country").countrySelect({defaultCountry: "ke", preferredCountries: ["ke", "ng", "in"]});
                    var _country = sessionStorage.getItem("country");
                    if (_country != null && _country != undefined) {
                        console.log(_country.toLowerCase());
                        $("#cbohotel_country").countrySelect("selectCountry", _country.toLowerCase());
                        var countryData = $("#cbohotel_country").countrySelect("getSelectedCountryData");
                        var selectedcountry = countryData["name"];
                        console.log(selectedcountry);
                    }

                    $("#txthotel_phone").intlTelInput({
                    ...
                    if (country != null && country != undefined) {
                        ...
                        $("#txthotel_phone").intlTelInput("selectCountry", country.toLowerCase());
                        var countryData = $("#txthotel_phone").countrySelect("getSelectedCountryData");
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Hotel/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
            ...
            function sendAjax() {
                ...
                var hotel_name = $('#txthotel_name').val();
                var hotel_phone = $('#txthotel_phone').val();
                var hotel_email = $('#txthotel_email').val();
                var hotel_address = $('#txthotel_address').val();
                var hotel_country = $('#cbohotel_country').val();
                ...
                if (hotel_phone.length == 0) {
                    errormsg += '<li>' + " Phone cannot be null " + '</li>';
                    $('#txthotel_phone').focus();
                    error_free = false;
                }
                if (hotel_email.length == 0) {
                    errormsg += '<li>' + " Email cannot be null " + '</li>';
                    $('#txthotel_email').focus();
                    error_free = false;
                }
                if (hotel_address.length == 0) {
                    errormsg += '<li>' + " Address cannot be null " + '</li>';
                    $('#txthotel_address').focus();
                    error_free = false;
                }
                if (hotel_country.length == 0) {
                    errormsg += '<li>' + " Select Country " + '</li>';
                    $('#cbohotel_country').focus();
                    error_free = false;
                }
                if (status.length == 0) {
