...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Hotels | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Hotels</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Hotels[ 
                                    <?php
                                    ...
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayhotels" style="height: auto; width: 100%;">

                                <div id="listHotelsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        if (count($hotels) > 0) {
                                            ...
                                            foreach ($hotels as $hotel) {
                                                echo "<tr>";
                                                echo "<td>" . $hotel['auto_id'] . "</td>";
                                                echo "<td>" . $hotel['hotel_name'] . "</td>";
                                                echo "<td>" . $hotel['hotel_phone'] . "</td>";
                                                echo "<td>" . $hotel['hotel_email'] . "</td>";
                                                echo "<td>" . $hotel['hotel_address'] . "</td>";
                                                echo "<td>" . $hotel['hotel_country'] . "</td>";
                                                echo "<td>" . $hotel['hotel_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $hotel['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $hotel['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteHotel.php" method="POST" id="form-delete-dialog">
