...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Create Station | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Create Station</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateStation.php" method="POST"  enctype="multipart/form-data">

                                <h1>Station Details Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Station Details Info</legend>
                                    ...
                                    <div class="divcol1container divcontainer">
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divinput">
                                                <input id="txtstation_description" name="txtstation_description" type="text" autocomplete="autocomplete" placeholder="Description" title="Description"   />
                                            </div>
...
//                                                    
        ...
        <script language="javascript" type="text/javascript">
            ...
            function sendAjax() {
                ...
                var description = $('#txtstation_description').val();
                var status = $('#cbostatus').val();

                if (description.length == 0) {
                    errormsg += '<li>' + " Description cannot be null " + '</li>';
                    $('#txtstation_description').focus();
                    error_free = false;
                }
                if (status.length == 0) {
