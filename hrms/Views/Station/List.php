...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Stations | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Stations</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Stations[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_stations";
                                    $stmt = $conn->query($sql_select);
                                    $stations = $stmt->fetchAll();
                                    echo count($stations);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaystations" style="height: auto; width: 100%;">

                                <div id="listStationsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listStationsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($stations) > 0) {
                                            ...
                                            foreach ($stations as $station) {
                                                echo "<tr>";
                                                echo "<td>" . $station['auto_id'] . "</td>";
                                                echo "<td>" . $station['station_description'] . "</td>";
                                                echo "<td>" . $station['station_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $station['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $station['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteStation.php" method="POST" id="form-delete-dialog">
