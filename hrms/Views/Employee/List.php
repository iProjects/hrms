...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Employees | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Employees</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Employees[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_employees";
                                    $stmt = $conn->query($sql_select);
                                    $employees = $stmt->fetchAll();
                                    echo count($employees);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayemployees" style="height: auto; width: 100%;">

                                <div id="listEmployeesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listEmployeesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($employees) > 0) {
                                            ...
                                            foreach ($employees as $employee) {
                                                echo "<tr>";
                                                echo "<td>" . $employee['auto_id'] . "</td>";
                                                echo "<td>" . $employee['employee_first_name'] . "</td>";
                                                echo "<td>" . $employee['employee_last_name'] . "</td>";
                                                echo "<td>" . $employee['employee_surname'] . "</td>";
                                                echo "<td>" . $employee['employee_date_of_birth'] . "</td>";
                                                echo "<td>" . $employee['employee_address'] . "</td>";
                                                echo "<td>" . $employee['employee_phone'] . "</td>";
                                                echo "<td>" . $employee['employee_email'] . "</td>";
                                                echo "<td>" . $employee['employee_pwd'] . "</td>";
                                                echo "<td>" . $employee['employee_job_title'] . "</td>";
                                                echo "<td>" . $employee['employee_no'] . "</td>";
                                                echo "<td>" . $employee['employee_gender'] . "</td>";
                                                echo "<td>" . $employee['employee_date_of_employment'] . "</td>";
                                                echo "<td>" . $employee['employee_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $employee['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $employee['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteEmployee.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Employee/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
