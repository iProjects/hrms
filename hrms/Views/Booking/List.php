...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Bookings | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Bookings</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Bookings[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_bookings";
                                    $stmt = $conn->query($sql_select);
                                    $bookings = $stmt->fetchAll();
                                    echo count($bookings);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaybookings" style="height: auto; width: 100%;">

                                <div id="listBookingsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listBookingsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        echo "<th>Customer</th>";
                                        ...
                                        if (count($bookings) > 0) {
                                            ...
                                            foreach ($bookings as $booking) {
                                                echo "<tr>";
                                                echo "<td>" . $booking['auto_id'] . "</td>";
                                                echo "<td>" . $booking['booking_customer_id'] . "</td>";
                                                echo "<td>" . $booking['booking_room_id'] . "</td>";
                                                echo "<td>" . $booking['booking_check_in_date'] . "</td>";
                                                echo "<td>" . $booking['booking_check_out_date'] . "</td>";
                                                echo "<td>" . $booking['booking_date'] . "</td>";
                                                echo "<td>" . $booking['booking_status'] . "</td>";
                                                echo '<td><a href="#" onclick="Edit(' . $booking['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $booking['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteBooking.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Booking/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
