...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Guest Types | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Guest Types</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Guest Types[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_guest_types";
                                    $stmt = $conn->query($sql_select);
                                    $guest_types = $stmt->fetchAll();
                                    echo count($guest_types);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplayguesttypes" style="height: auto; width: 100%;">

                                <div id="listGuestTypesResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listGuestTypesTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($guest_types) > 0) {
                                            ...
                                            foreach ($guest_types as $guest_type) {
                                                echo "<tr>";
                                                echo "<td>" . $guest_type['auto_id'] . "</td>";
                                                echo "<td>" . $guest_type['gt_description'] . "</td>";
                                                echo "<td>" . $guest_type['gt_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $guest_type['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $guest_type['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteGuestType.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/GuestType/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
