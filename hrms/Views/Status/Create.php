...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Create Status | Hotel Reservation Management System</title>
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Create Status</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div style="clear: both;float: left;">
                            ...
                            <form id="wizard" action="../../DAL/CreateStatus.php" method="POST"  enctype="multipart/form-data">

                                <h1>Status Details Info</h1>
                                <fieldset class="fieldset">
                                    <legend>Specify Status Details Info</legend>
                                    ...
                                    <div class="divcol1container divcontainer">
                                        ...
                                        <div class="divcol1">
                                            ...
                                            <div class="divinput">
                                                <input id="txtstatus_description" name="txtstatus_description" type="text" autocomplete="autocomplete" placeholder="Description" title="Description"   />
                                            </div>
