...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Status | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Status</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Status[ 
                                    <?php
                                    ...
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaystatus" style="height: auto; width: 100%;">

                                <div id="listStatusResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        if (count($statuses) > 0) {
                                            ...
                                            foreach ($statuses as $status) {
                                                echo "<tr>";
                                                echo "<td>" . $status['auto_id'] . "</td>";
                                                echo "<td>" . $status['status_description'] . "</td>";
                                                echo "<td>" . $status['status_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $status['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $status['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteStatus.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Status/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
