...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head id="header">
        ...
        <title>Locations | Hotel Reservation Management System</title>
    ...
    <body id="frmmain">
                ...
                <div id="div-site-title">
                    ...
                    <div style="float: left; clear: both; position: relative; display: block;">
                        ...
                        <div id="divtitle">
                            ...
                            <span class="pagetitle">Hotel Reservation Management System - Locations</span>
                ...
                <div id="body">
                    ...
                    <div class="content-wrapper main-content">
                        ...
                        <div class="divtabledisplay" style="float: left; clear: both; padding-top: 20px; height: auto !important; width: 100%;">
                            <div> <h2 class="page-title">Locations[ 
                                    <?php
                                    $sql_select = "SELECT * FROM hrms_locations";
                                    $stmt = $conn->query($sql_select);
                                    $locations = $stmt->fetchAll();
                                    echo count($locations);
                                    $stmt->closeCursor();
                                    ?> ]</h2></div>
                            <div id="divtabledisplaylocations" style="height: auto; width: 100%;">

                                <div id="listLocationsResult" style="clear: both; padding-bottom: 20px !important;">
                                    ...
                                    try {
                                        ...
                                        echo "<table id='listLocationsTable'>";
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<th>Id</th>";
                                        ...
                                        if (count($locations) > 0) {
                                            ...
                                            foreach ($locations as $location) {
                                                echo "<tr>";
                                                echo "<td>" . $location['auto_id'] . "</td>";
                                                echo "<td>" . $location['loc_description'] . "</td>";
                                                echo "<td>" . $location['loc_status'] . "</td>"; 
                                                echo '<td><a href="#" onclick="Edit(' . $location['auto_id'] . ')">Edit</a>';
                                                echo '<td><a href="#" onclick="Delete(' . $location['auto_id'] . ')">Delete</a>';
                                                echo "</tr>";
                                            }
                                        }
                                        echo "</tbody>";
                                ...
                                <form action="../../DAL/DeleteLocation.php" method="POST" id="form-delete-dialog">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function CreateSubMenu() {
                ...
                SubMenu
                        .push('<li><a href="../../Views/Location/Create.php" style="cursor: pointer;" title="Create">Create</a></li>');
                SubMenu.push('</ul></div>');
